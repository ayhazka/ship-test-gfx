...
extern "C" void gDPSetTextureImage(Gfx *pkt, u32 format, u32 size, u32 width,
                                   void *i) {
  __gDPSetTextureImage(pkt, format, size, width, i);
}

extern "C" void gDPSetTextureImageFB(Gfx *pkt, u32 format, u32 size, u32 width,
                                     int fb) {
...
extern "C" void gSPVertex(Gfx *pkt, void *v, int n, int v0) {
  if (OTRSigCheck((char *)v) == 1)
    v = (Vtx *)ResourceGetDataByName((char *)v);
